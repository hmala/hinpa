...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> قائمة
 الاسرة الغير موثقة</span>
        </div>
    </div>
                              ...
                              @can('توثيق')
                                <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    type="button">توثيق<i class="fas fa-caret-down ml-1"></i></button>
                                                <div class="dropdown-menu tx-13">
                                                   
                                                      
                                                       
                                                            <a class="dropdown-item"
                                                            href="{{ URL::route('status_show', [$pations->id]) }}"><i
