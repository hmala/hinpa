                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab4">
                                            <div class="table-responsive mt-15">
                                                ...
                                                <form method="POST" action="{{ route('hwadths.store') }}">
                                                    @csrf
                                                    <div class="row">
        <div class="col">
                ...
                @endfor
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="number" name="livebnt" id="livebnt" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="number" id="livebst" name="livebst" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input type="number" name="totalbm" id="totalbm" class="form-control"
                                                                readonly>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="totalbf" id="totalbf" class="form-control"
                                                                readonly>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="totalbkh" id="totalbkh" class="form-control"
                                                                readonly>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="totalbt" id="totalbt" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadnm" id="bdeadnm" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadnm', 'bdeadnf', 'bdeadnkh', 'bdeadnt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadnf" id="bdeadnf" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadnm', 'bdeadnf', 'bdeadnkh', 'bdeadnt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadnkh" id="bdeadnkh" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadnm', 'bdeadnf', 'bdeadnkh', 'bdeadnt')" required >
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadnt" id="bdeadnt" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadsm" id="bdeadsm" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadsm', 'bdeadsf', 'bdeadskh', 'bdeadst')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadsf" id="bdeadsf" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadsm', 'bdeadsf', 'bdeadskh', 'bdeadst')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadskh" id="bdeadskh" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('bdeadsm', 'bdeadsf', 'bdeadskh', 'bdeadst')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="bdeadst" id="bdeadst" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadlm" id="deadlm" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadlm', 'deadlf', 'deadlkh', 'deadlt')"required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadlf" id="deadlf" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadlm', 'deadlf', 'deadlkh', 'deadlt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadlkh" id="deadlkh" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadlm', 'deadlf', 'deadlkh', 'deadlt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadlt" id="deadlt" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadmm" id="deadmm" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadmm', 'deadmf', 'deadmkh', 'deadmt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadmf" id="deadmf" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadmm', 'deadmf', 'deadmkh', 'deadmt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number" name="deadmkh" id="deadmkh" class="form-control"
                                                                placeholder="أدخل العدد"
                                                                oninput="calculateTotal('deadmm', 'deadmf', 'deadmkh', 'deadmt')" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="number"  name="deadmt" id="deadmt" class="form-control"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-3">
                                                            <input readonly type="number" id="mdeadm" name="mdeadm"
                                                                class="form-control" placeholder="أدخل العدد"
                                                        ...
                                                        <div class="col-md-3">
                                                            <input readonly type="number" id="mdeadkh" name="mdeadkh"
                                                                class="form-control" placeholder="أدخل العدد"
                                                                oninput="calculateTotal('mdeadm', 'mdeadf', 'mdeadkh', 'mdeadt')"
                                                                required value="0">
                                                        </div>
